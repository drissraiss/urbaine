...
<body>
            ...
            <nav class="p-0 d-none d-sm-inline col-auto" id="nav">
                <div id="menu" class="mt-4">
                    <ul class="list-unstyled">
                        ...
                        <li class="m-4 fw-bold btn-messages"><i data-toggle="tooltip" title="Messages" class="bi bi-chat-left-text-fill"></i><span class="ms-3 d-none d-xl-inline">Messages</span>
                        </li>
                        <li class="m-4 fw-bold btn-profile"><i data-toggle="tooltip" title="Profile" class="bi bi-person-fill"></i><span class="ms-3 d-none d-xl-inline">Profile</span></li>
    ...
    <script>
        setInterval(() => {
            $.ajax({
                url: "../php/php_cl/Employes.php?do=mise_a_jour_status",
    ...
    <script src="../scripts/emp/emp.js"></script>
