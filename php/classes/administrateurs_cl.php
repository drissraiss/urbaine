...
?>
        <div class="notifications" style="position: relative;">
            ...
            <nav class="nav nav-borders ">
                ...
                <span class="nav-link c-pointer" id="btn-add-notification">Ajouter un notification</span>
            ...
            <div id="div-show-my-notifications" class="div-frame">
                ...
                <table class="table table-hover" id="table-notification-first" style="border-collapse: separate; border-spacing:0 20px">
                    <tbody>
                        <?php
                        require_once('../php_cl/Administrateurs.php');
            ...
            <div id="div-add-notification" class="div-frame mt-4" style="display: none;">
                <!-- s add-notification -->
                ...
                <div class="table-responsive mt-4">
                    <table class="table table-hover bg-white" id="notification-my-table-all">
                        ...
                        <tbody>
                            <?php
                            require_once('../php_cl/Administrateurs.php');
                            $result = CompteAdmiadministrateurs::afficher_notifications_admin();
        ...
        <script>
            ...
            $("#form-add-notification").on("submit", function(e) {
                ...
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=envoyer_notification_admin",
                    type: "POST",
                    data: formData,
            ...
            $('.notifications #div-notification-emp .notification-my-short').click(function() {
                ...
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=afficher_info_admin_ma_notifications",
                    type: "POST",
                    data: {
            ...
            $(".tr-notification").each(function() {
                $(this).click(() => {
                    ...
                    $.ajax({
                        url: "../php/php_cl/Administrateurs.php?do=afficher_info_notification_admin_content",
                        type: "POST",
                        data: {
            ...
            $(".read-notification").click(function() {
                ...
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=lire_notif_directeur",
                    type: "POST",
                    data: {
    ...
    ?>
        ...
        <script>
            setInterval(() => {
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=afficher_list_friend_short",
                    success: function(result) {
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#form-update-profil").submit(function(e) {
                    ...
                    let formData = new FormData(this);
                    $.ajax({
                        url: "../php/php_cl/Administrateurs.php?do=mise_a_jour_image_de_profil",
                        type: "POST",
                        data: formData,
                        success: function(result) {
                            if (result == 1) {
                ...
                $("#form_update_info").on("submit", function(ev) {
                    ...
                    $.ajax({
                        url: "../php/php_cl/Administrateurs.php?do=mise_a_jour_info",
                        type: "POST",
                        data: formData,
                        success: function(result) {
                ...
                $('#form-update-email').on('submit', function(e) {
                    ...
                    // update email
                    $.ajax({
                        url: "../php/php_cl/Administrateurs.php?do=mise_a_jour_email",
                        type: "POST",
                        data: formData,
                        success: function(result) {
                            //alert(result)
                ...
                $('#form-update-password').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: "../php/php_cl/Administrateurs.php?do=mise_a_jour_mote_de_pass",
                        type: "POST",
                        data: formData,
                        success: function(result) {
                            if (result == "success") {
    ...
    ?>
        ...
        <div class="demandes ">
            ...
            <nav class="nav nav-borders ">
                ...
                <span class="nav-link c-pointer" id="btn-show-employees-demandes">Demandes employés</span>
            </nav>
            <hr class="mt-0 mb-0">
            <!-- s add-demande -->
                    ...
                    <div id="demande-table" class="table-responsive mt-4">
                        <table class="table table-hover bg-white">
                            ...
                            <tbody>
                                <?php
                                require_once('../php_cl/Administrateurs.php');
                                $result = CompteAdmiadministrateurs::afficher_demandes_admin();
            ...
            <div id="show-employees-demandes" class="div-frame" style="display:none">
                <div>
        ...
        <script>
            ...
            $('#form-demande-admin').on('submit', function(e) {
                ...
                let formData = new FormData(this)
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=envoyer_demande_admin",
                    type: "POST",
                    data: formData,
                    success: function(result) {
                        if (result == 1) {
            ...
            $('.demandes #show-employees-demandes .demande-employee-short').click(function() {
                ...
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=afficher_info_demande",
                    type: "POST",
                    data: {
            ...
            $('.demandes #show-my-demandes .demande-short').click(function() {
                ...
                $('#demande-info').show()
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=afficher_info_ma_demande",
                    type: "POST",
                    data: {
                        id_demande: $(this).attr('id-demande')
                    },
    ...
    ?>
        ...
        <div class="plaintes">
            ...
            <nav class="nav nav-borders ">
                ...
                <span class="nav-link c-pointer" id="btn-show-employees-plaintes">Plaintes employés</span>
            </nav>
            <hr class="mt-0 mb-0">
            <!-- s add-plainte -->
                    ...
                    <div id="plainte-table" class="table-responsive mt-4">
                        <table class="table table-hover bg-white">
                            ...
                            <tbody>
                                <?php
                                require_once('../php_cl/Administrateurs.php');
                                $result = CompteAdmiadministrateurs::afficher_plaintes_admin();
            ...
            <div id="show-employees-plaintes" class="div-frame" style="display: none;">
                <div>
        ...
        <script>
            ...
            $('.plaintes #show-employees-plaintes .plainte-employee-short').click(function() {
                ...
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=afficher_info_plainte",
                    type: "POST",
                    data: {
            ...
            $('#form-plainte-admin').on('submit', function(e) {
                ...
                let formData = new FormData(this)
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=envoyer_plainte_admin",
                    type: "POST",
                    data: formData,
                    success: function(result) {
                        if (result == 1) {
            ...
            $('.plaintes #show-my-plaintes .plainte-short').click(function() {
                ...
                $('#plainte-info').show()
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=afficher_info_ma_plainte",
                    type: "POST",
                    data: {
                        id_plainte: $(this).attr('id-plainte')
                    },
    ...
    ?>
        ...
        <script>
            ...
            $('.table-employes tbody tr').click(function() {
                ...
                //
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=afficher_info_employe",
                    type: "POST",
                    data: {
            ...
            $('#form-ajouter-emp').on('submit', function(e) {
                ...
                let formData = new FormData(this);
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=ajouter_emp",
                    type: "POST",
                    data: formData,
                    success: function(result) {
