...
class CompteAdmiadministrateurs
{
    public static function verification_de_la_requete()
    {
        $req = "select * from administrateurs where id='" . $_SESSION['compte']['id'] . "'";
    ...
    public static function afficher_info_notification_admin()
    {
        ...
        //$req = "SELECT * FROM `notifications_directeur` where id_service='" . $_SESSION['compte']['id_service'] . "'";
        $req = "select notifications_directeur.id, notifications_directeur.id_service, notifications_directeur.titre, notifications_directeur.notification, notifications_directeur.date, notifications_directeur_vu.id as vu from notifications_directeur left join notifications_directeur_vu on notifications_directeur_vu.id_notification=notifications_directeur.id  and (notifications_directeur_vu.id_administrateur = '" . $_SESSION['compte']['id'] . "' or notifications_directeur_vu.id_administrateur is null) where notifications_directeur.id_service='" . $_SESSION['compte']['id_service'] . "'";
        $query = mysqli_query(CONNECT, $req);
        return $query;
    }
...
?>
        ...
        <script>
            $('.msg-short').click(function() {
                ...
                $("#box-chatt").show()
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=afficher_box_msg",
                    type: "POST",
    ...
    public static function mise_a_jour_header_freind()
    {
        ...
        $result = CompteAdmiadministrateurs::afficher_box_msg($_POST['role_he'], $_POST['id_he']);
...
switch (@$_GET['do']) {
    case 'mise_a_jour_info':
        $result = CompteAdmiadministrateurs::mise_a_jour_info();
        if ($result) {
    ...
    case 'mise_a_jour_image_de_profil':
        $result = CompteAdmiadministrateurs::mise_a_jour_image_de_profil();
        if ($result) {
            $req = "SELECT * FROM administrateurs WHERE email='" . $_SESSION['compte']['email'] . "' and mote_de_pass='" . $_SESSION['compte']['mote_de_pass'] . "'";
            $_SESSION['compte'] = mysqli_fetch_assoc(mysqli_query(CONNECT, $req));
        }
    ...
    case 'mise_a_jour_email':
        $result = CompteAdmiadministrateurs::mise_a_jour_email();
        if ($result) {
    ...
    case 'mise_a_jour_mote_de_pass':
        $result = CompteAdmiadministrateurs::mise_a_jour_mote_de_pass();
        if ($result) {
    ...
    case 'afficher_les_employes':
        $result = CompteAdmiadministrateurs::afficher_les_employes();
    ...
    case "afficher_info_employe":
        $result = CompteAdmiadministrateurs::afficher_info_employe();
        $data = mysqli_fetch_assoc($result);
        ?>
        ...
        <script>
            $('#change_statu_compte_emp').on('change', function() {
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=change_statu_compte_emp",
                    type: "POST",
                    data: {
    ...
    case 'change_statu_compte_emp':
        $result = CompteAdmiadministrateurs::change_statu_compte_emp();
        //echo $result;
        exit();

    case 'ajouter_emp':
        $result = CompteAdmiadministrateurs::ajouter_emp();
        echo $result;
        exit();
        // plaintes 
        /*     case 'afficher_plaintes_emps':
    $result = CompteAdmiadministrateurs::afficher_plaintes_emps();
    ...
    */
    ...
    case 'afficher_info_plainte':
        $result = CompteAdmiadministrateurs::afficher_info_plainte();
        $data = mysqli_fetch_assoc($result);
    ?>
        <div class="mb-3 pt-4">
    ...
    case 'envoyer_plainte_admin':
        $result = CompteAdmiadministrateurs::envoyer_plainte_admin();
        echo $result;
        exit();
    case 'afficher_info_ma_plainte':
        $result = CompteAdmiadministrateurs::afficher_info_ma_plainte();
        $data = mysqli_fetch_assoc($result);
    ?>
        <div class="mb-3 pt-4">
            <label class="form-label">Titre</label>
    ...
    $result = CompteAdmiadministrateurs::afficher_demandes_emps();
    ...
    case 'afficher_info_demande':
        $result = CompteAdmiadministrateurs::afficher_info_demande();
    ...
    ?>
        ...
        <script>
            $(".reponse_demande_select_i").on('change', function() {
                $.ajax({
                    url: "../php/php_cl/Administrateurs.php?do=mise_a_jour_reponse_demande",
                    type: "POST",
                    data: {
                        reponse: $(this).val(),
    ...
    case 'envoyer_demande_admin':
        $result = CompteAdmiadministrateurs::envoyer_demande_admin();
        echo $result;
        exit();
    case 'afficher_info_ma_demande':
        $result = CompteAdmiadministrateurs::afficher_info_ma_demande();
        $data = mysqli_fetch_assoc($result);
    ?>
        <div class="mb-3 pt-4">
            <label class="form-label">Titre</label>
    ...
    case "mise_a_jour_reponse_demande":
        $result = CompteAdmiadministrateurs::mise_a_jour_reponse_demande();
        echo $result;
        exit();
    case "envoyer_notification_admin":
        $result = CompteAdmiadministrateurs::envoyer_notification_admin();
        echo $result;
        exit();
    case "afficher_info_admin_ma_notifications":
        $result = CompteAdmiadministrateurs::afficher_info_admin_ma_notifications();
        ...
        <div class="bg-white p-2">
            ...
            <div class="table-responseve">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        $result = CompteAdmiadministrateurs::afficher_emps_notifications_vu($notification['id']);
    ...
    case "afficher_info_notification_admin":
        $result = CompteAdmiadministrateurs::afficher_info_notification_admin();
    ...
    case "afficher_info_notification_admin_content":
        $result = CompteAdmiadministrateurs::afficher_info_notification_admin_content();
        $notification = mysqli_fetch_assoc($result);
        ?>
        <table class="table w-auto table-borderless  fs-4">
            <tr>
    ...
    case "lire_notif_directeur":
        $result = CompteAdmiadministrateurs::lire_notif_directeur();
        echo $result;
        exit();
    case "virifier_si_notif_directeur_et_lire":
        $result = CompteAdmiadministrateurs::virifier_si_notif_directeur_et_lire();
        echo $result;
        exit();
    case "afficher_msgs":
        $result = CompteAdmiadministrateurs::afficher_msgs($_SESSION["compte"]['id'], "administrateurs", $_POST['id_he'], $_POST['role_he']);
    ...
    ?>
        ...
        <script>
            function send_msg() {
                if ($("#input-message-aeria").val().trim() != "") {
                    $.ajax({
                        url: "../php/php_cl/Administrateurs.php?do=envoyer_msg",
                        type: "POST",
                        data: {
            ...
            var update_box_msg = setInterval(() => {
                try {
                    ...
                    $.ajax({
                        url: "../php/php_cl/Administrateurs.php?do=mise_a_jour_box_message",
                        type: "POST",
                        data: {
            ...
            var inter_val_header_friend = setInterval(() => {
                try {
                    ...
                    $.ajax({
                        url: "../php/php_cl/Administrateurs.php?do=mise_a_jour_header_freind",
                        type: "POST",
                        data: {
        ...
        exit();
    case "envoyer_msg":
        $result = CompteAdmiadministrateurs::envoyer_msg();
        echo $result;
        exit();
...
<?php
    ...
    case "afficher_list_friend_short":
        CompteAdmiadministrateurs::afficher_liste_box_messages_admin_emp();
        exit();
    case "mise_a_jour_status":
        $result = CompteAdmiadministrateurs::mise_a_jour_status();
        echo $result;
        exit();
    case "mise_a_jour_header_freind":
        $result = CompteAdmiadministrateurs::mise_a_jour_header_freind();
        echo $result;
        exit();
        /* case "":
    $result = CompteAdmiadministrateurs::func();
    echo $result;
    exit(); */
    default:
        # code...
